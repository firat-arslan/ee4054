...
class MatplotlibWidget(QMainWindow):
    ...
    def message(self):
        ...
        message.setWindowTitle("Succesfull")
        message.setStandardButtons(QMessageBox.Ok)
        message.exec()
    ...
    def loadShifting(self):
        ...
        KNearestNeighbour.classification(path)
        self.pixmap1 = QPixmap('figure_images/saved_figure_loadShifting1.png')
        self.figureLabel_3.setPixmap(self.pixmap1)
        self.show()
        self.pixmap2 = QPixmap('figure_images/saved_figure_loadShifting2.png')
